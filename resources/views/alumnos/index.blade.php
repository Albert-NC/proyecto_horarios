        ...
        <div>
            ...
            <p class="text-sm"
               :class="tema === 'oscuro' ? 'text-gray-400' : 'text-slate-600'">
                Listado de alumnos registrados en el sistema.
            </p>
        </div>
...
<button
    type="button"
    @click="$refs.modalImportarAlumnos.showModal()"
    ...
    >
        ...
        <div class="flex justify-end gap-2 pt-2 border-t border-white/10">
            <button
                ...
                @click="$refs.modalImportarAlumnos.close()"
            >
                Cancelar
            </button>
